...
<html lang="en">
  <head>
    ...
    <title>DFLCMCFI|| Update Contact Us</title>
    <!-- plugins:css -->
...
{               ?>    
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="mobnum" id="mobnum" required="true" value="<?php  echo $row->MobileNumber;?>" class="form-control" maxlength="15" pattern="[0-9]+">
                      </div>
                      <?php $cnt=$cnt+1;}} ?>
