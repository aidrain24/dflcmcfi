...
{               ?>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="mobilenumber" value="<?php  echo $row->MobileNumber;?>"  class="form-control" maxlength='12' required='true' pattern="[0-9]+">
                      </div>
                      <div class="form-group">
